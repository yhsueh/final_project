...
The base class initializes all the necessary publishers, subscribers, servers and clients. It also takes cares of the callbacks for subscribers and servers. It\textquotesingle{}s core function is to locate the ball objects and command the turtlebot to reach it.\+Constructor
...
This function is the service callback from the turtle\+Ctrller node. It recieves a request when a model in Gazebo is removed.\+Check ball removal
